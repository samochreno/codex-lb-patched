...
The build was validated with normal responses, Codex CLI model
...
```text
ghcr.io/samochreno/codex-lb-patched:patched-2026-07-24
```

Authenticate before pulling if the package is private:
